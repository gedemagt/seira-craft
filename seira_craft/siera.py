...
class Siera(Generic[T]):
    ...
    def __init__(self, crafter: Crafter[T], group_by: Callable[[T], Hashable] = None, sequence: List[T] = None):
    ...
    def insert(self, new_instance: T, **kwargs) -> 'Siera':
        ...
        self._sequences[key] = self.crafter.insert(new_instance, self._sequences[key], **kwargs)
        return self
